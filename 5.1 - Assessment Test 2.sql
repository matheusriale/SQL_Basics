...
a fee to members, and that fee is less than 1/50th 
of the monthly maintenance cost? Return the facid, 
...
SELECT * FROM cd.facilities
WHERE facid%2 = 1 AND 10%facid = 0; 
--WHERE facid = 1 OR facid = 5;

/*
How can you produce a list of members who joined 
...
/*
Produce a count of the number of facilities
...
facility in the month of September 2012. 
